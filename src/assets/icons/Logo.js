...
function Logo({ size }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={size} height={size}>
      <linearGradient id="j60VCtKB9ZT9t2svrZTTfa" x1="19" x2="19" y1="15" y2="23" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#6dc7ff" />
        <stop offset="1" stopColor="#e6abff" />
      </linearGradient>
      <circle cx="19" cy="19" r="4" fill="url(#j60VCtKB9ZT9t2svrZTTfa)" />
      <linearGradient id="j60VCtKB9ZT9t2svrZTTfb" x1="19" x2="19" y1="28" y2="36" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#6dc7ff" />
        <stop offset="1" stopColor="#e6abff" />
      </linearGradient>
      <circle cx="19" cy="32" r="4" fill="url(#j60VCtKB9ZT9t2svrZTTfb)" />
      <linearGradient id="j60VCtKB9ZT9t2svrZTTfc" x1="19" x2="19" y1="41" y2="49" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#6dc7ff" />
        <stop offset="1" stopColor="#e6abff" />
      </linearGradient>
      <circle cx="19" cy="45" r="4" fill="url(#j60VCtKB9ZT9t2svrZTTfc)" />
      <linearGradient id="j60VCtKB9ZT9t2svrZTTfd" x1="32" x2="32" y1="9" y2="55" gradientUnits="userSpaceOnUse">
